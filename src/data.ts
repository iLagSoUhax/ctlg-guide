...
const fetchJson = async (
  ...
  return fetchJsonWithProgress(
    `https://raw.githubusercontent.com/iLagSoUhax/ctlg-data/main/data/${version}/all.json`,
    progress
  );
};
...
const fetchLocaleJson = async (
  ...
  return fetchJsonWithProgress(
    `https://raw.githubusercontent.com/iLagSoUhax/ctlg-data/main/data/${version}/lang/${locale}.json`,
    progress
  );
};
